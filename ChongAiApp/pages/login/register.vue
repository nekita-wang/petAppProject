<template>
	<view class="profile-container">
		...
		<view class="avatar-upload" @click="UploadImage">
			<up-image width="100%" height="100%" :src="rgtReactive.avatarUrl" shape="circle">
			</up-image>
		</view>
		<!-- 表单区域 -->
			...
			<view class="form-item">
				...
				<view class="form-item-pwd">
					<up-input shape="circle" clearable v-model="rgtReactive.passwordConfirm"
						:type="pwdReactive.showCmPassword ? 'text' : 'password'" placeholder="请输入确认密码"
						:passwordIcon="false" maxlength="10">
						<template #suffix>
							<up-icon :name="pwdReactive.showCmPassword ? 'eye-fill' : 'eye-off'"
								:color="pwdReactive.showCmPassword ? '#2979ff' : '#c0c4cc'" size="25" @click="
